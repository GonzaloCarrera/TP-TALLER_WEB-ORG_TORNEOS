...
<html lang="en">
   ...
   <body class="game_info" data-spy="scroll" data-target=".header">
      ...
      <div class="inner-information-text">
            <div class="container">
               <h3>Seleccionar Horario de la fecha</h3>
               <ul class="breadcrumb">
                  ...
                  <div class="col-md-6 col-md-offset-3">
                     <div class="contact-us">
                      <div id="hayError" class="alert alert-danger"></div>
						<form:form action="iniciar-fecha-torneo" method="POST" onsubmit="return validacion()">
					    	<h2 stye="text-align:center">Seleccione el rango horario de la fecha</h2>
